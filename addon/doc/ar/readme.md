...
التوافقية مع إصدارات NVDA: 2024.2 فما فوق  
تحميل [الإصدار 3.3.0][1]  
...
## الإعلان عن عنوان صفحة الويب أو نسخها

إذا كنت على صفحة ويب وترغب في معرفة عنوان الصفحة، اضغط الاختصار مرة واحدة، وإذا كنت ترغب في نسخ العنوان إلى الحافظة، اضغطه مرتين.

هذه الميزة لا تحتوي على اختصار معيّن مسبقاً، لذلك يجب أن تقوم بتعيين اختصار لها بنفسك، وذلك عبر:

قائمة NVDA / التفضيلات / إيماءات الإدخال / فتح الرابط باستخدام / إعلان عنوان أو رابط صفحة ويب عند الضغط مرة واحدة، ونسخه إلى الحافظة عند الضغط مرتين.

## التغييرات في الإصدار 3.3.0 ##

*	إضافة ميزة جديدة، تعلن عنوان صفحة ويب عند الضغط على الاختصار مرة واحدة، وتنسخه إلى الحافظة عند الضغط مرتين.  

## التغييرات الخاصة بالإصدار 3.2.9 ##

*	تستخدم الإضافة الآن NVDA pre_speech extension point بدلاً من تعديل وظيفة النطق الأساسية.  
*	الحد الأدنى لإصدار NVDA المطلوب هو 2024.2 (لأن هذه الـ extension point أُضيفت في ذلك الإصدار).  
*	عند جمع النص المنطوق، تستخدم الإضافة NVDA CHUNK_SEPARATOR مما يجعل استخراج الروابط أنظف وأكثر دقة.  
*	في ميزة قائمة الروابط (Hyper link menu)، أصبحت الإضافة تتعرف على الروابط داخل العناصر المتداخلة والكائنات الرسومية، باستخدام نفس النهج الذي يعتمده NVDA core، مما يجعلها قادرة على اكتشاف المزيد من الروابط.  
*	وكالعادة، الفضل يعود إلى [Cary Rowen](https://github.com/cary-rowen)، شكراً لك يا Cary!  

## التغييرات الخاصة بالإصدار 3.2.7 ##

*	تمت إضافة وحدة جديدة urlutility.py لتحليل الروابط والتحقق من صحتها بشكل قوي.
*	تحسين استخراج الروابط وفحصها عبر جميع أجزاء الرابط — كانت هناك مشاكل في النتائج سابقًا، والتي يُفترض أنها قد تم إصلاحها الآن.
*	تمت إضافة مجموعة كاملة من اختبارات الوحدة في tests/unit/test_urlUtils.py لضمان الموثوقية.
*	يعود الفضل الكامل في هذا إلى [Cary Rowen](https://github.com/cary-rowen). شكرًا لك يا كاري!

## التغييرات الخاصة بالإصدار 3.2.5 ##

*	لقد تم تحديث الحد الأدنى من الإصدار الذي تم اختباره إلى 2021.1، وتم إزالة التعليمات البرمجية ذات الصلة بـ versionInfo.
*	لقد تم تحديث ملفات قالب الإضافة.
